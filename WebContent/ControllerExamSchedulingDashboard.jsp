...
<body>
	...
	<div class="body_bar">
			...
			<div style="height:350px;width:22%;position:absolute;top:100px;left:38%;background-color:#d0d7fb;border-radius:10px;">
			<form action="ControllerExamScheduling.jsp">
				...
				<p style="left:80px;top:100px;position:absolute">Exam<p>
					<select style="left:80px;top:145px;position:absolute" name="examType">
					    <option value="mid1">Mid I</option>
					    <option value="mid2">Mid II</option>
					    <option value="sem">Semester</option>
					</select>
				<input style="left:100px;top:220px;position:absolute" type="Submit" value="Continue">
