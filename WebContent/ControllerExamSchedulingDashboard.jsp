<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.dao.AcadYearDao" import="com.dto.Controller" import="com.dao.ControllerDao" import="com.dto.ExamTask" import="com.dao.ExamTaskDao" import="java.util.List" import="com.dao.Today" %>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="body_bar">
			...
			int currSem = acadYearDao.getSemester(1);
			%>
