...
<body>
	...
	<div class="body_bar">
		...
		<p style="font-size:23px;top:50px;left:500px;position:absolute"><strong>Paper Setting Scheduling</strong></p>
		<div style="height:370px;width:33%;position:absolute;top:130px;left:33.5%;background-color:#b9c4f9;border-radius:10px;">
			<form action="ControllerSettingScheduling" method="post">
				...
				<p style="left:80px;top:190px;position:absolute">Close Date<p>
				<input style="left:80px;top:235px;position:absolute" size="20" type="date" onkeydown="return false" name="closeDate" required>
